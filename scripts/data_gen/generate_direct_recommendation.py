...
1. Create a **realistic user query** that someone might type when looking for this kind of movie (brief and natural — no technical terms).
2. Generate a chatbot-style recommendation response that recommends the given movie that is friendly, casual, and includes 1–3 appropriate emojis (e.g., 🎬, 🦸, 😢, ❤️, 😂).
